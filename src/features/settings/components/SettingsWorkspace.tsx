...
export function SettingsWorkspace() {
    ...
    const quickLinks = typedUser
        ? getNavigationItemsForSurface(typedUser.role, 'settingsQuickLinks')
        : []
                ...
                <SettingsGroup title="Your Tools">
                    {quickLinks.map((link, index) => (
                        ...
                        >
                            ...
                            {link.settingsMeta && (
                                <span className="text-[13px] text-neutral-400">{link.settingsMeta}</span>
                            )}
