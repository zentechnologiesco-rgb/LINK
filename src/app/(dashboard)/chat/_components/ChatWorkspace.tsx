...
import { ConversationInboxSkeleton } from './ConversationInboxSkeleton'
import { SupportThreadComposer } from './SupportThreadComposer'
import {
    ...
    supportStatusLabel,
    supportStatusTone,
} from '../_lib/chat-workspace-helpers'
import type {
    AnnouncementDraft,
    ConversationKind,
    InboxFilter,
            ...
            <div className="flex h-[calc(100dvh-4rem)] flex-col md:h-[calc(100dvh-5rem)]">
                ...
                <div className="flex-1 overflow-hidden">
                    {Array.from({ length: 7 }).map((_, i) => (
                        <ConversationInboxSkeleton key={i} />
                    ))}
                </div>
            </div>
        )
            ...
            <Dialog open={supportDialogOpen} onOpenChange={setSupportDialogOpen}>
                <DialogContent className="max-w-lg rounded-2xl border-neutral-100 p-5 sm:p-6">
                    ...
                    <SupportThreadComposer
                        ...
                        isSubmitting={isCreatingSupportThread}
                    />
                </DialogContent>
            </Dialog>
