        ...
        <div className="px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {(lease.tenant_documents || lease.tenantDocuments) && (lease.tenant_documents || lease.tenantDocuments).length > 0 && (
                            ...
                            <CardContent className="p-0">
                                <div className="divide-y">
                                    {payments.map((payment: any) => (
                                        <div key={payment.id || payment._id} className="flex items-center justify-between p-4">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                {payment.status === 'pending' && (
                                                    <Button size="sm" onClick={() => handleMarkPaid(payment.id || payment._id)}>
                                                        Mark Paid
                                                    </Button>
                                                )}
                                            </div>
                        ...
                        <Card className="gap-0 py-0">
                            ...
                            <CardContent>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="font-semibold">{lease.tenant.fullName || 'Tenant'}</p>
